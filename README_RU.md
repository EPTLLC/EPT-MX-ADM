...
Мы создаем экосистему **Matrix.Family** — комплексная экосистема Matrix, включающая веб-клиент, Matrix сервер, панель администрирования и другие компоненты.

**Новая универсальная админка Matrix находится в репозитории:**  
**[https://github.com/EPTLLC/Matrix-Family-Admin](https://github.com/EPTLLC/Matrix-Family-Admin)**

Вся дальнейшая разработка, обновления и поддержка админки Matrix будут предоставляться в новом репозитории в рамках экосистемы Matrix.Family.
